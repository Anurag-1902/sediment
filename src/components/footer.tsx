  ...
  return (
    <footer className="border-t border-border-custom bg-charcoal">
      <div className="container mx-auto px-6 py-16">
            ...
            <ul className="space-y-3">
              {["Features", "Integrations", "Changelog"].map((item) => (
                <li key={item}>
                  <Link
                    href="#"
                    className="text-sm text-text-muted hover:text-amber-light transition-colors"
                  >
                    {item}
                  </Link>
                </li>
        ...
        <div className="mt-12 pt-8 border-t border-border-custom flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-text-muted">
            &copy; 2024 Sediment. All rights reserved.
          </p>
